...
__version__ = '0.1.0'
__description__ = ''
__author__ = 'Jenna Palmer  <emptyeggcartons@gmail.com> '
__revisedBy__= 'Jack Ogaja'
__license__ = ''
...
# nd = 4
 ...
 np.savetxt('l.txt',lj,fmt='%.5f')
 np.savetxt('t.txt',tj,fmt='%.5f')
 np.savetxt('r.txt',rj,fmt='%.5f')
